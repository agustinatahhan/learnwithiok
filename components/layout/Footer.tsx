      ...
      <div className="px-6 lg:px-30 py-8 flex flex-row items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            aria-label="Correo"
            className="w-10 h-10 rounded-full bg-linear-to-r from-blue to-violet flex items-center justify-center text-white hover:opacity-80 transition-all duration-300 ease-in-out
